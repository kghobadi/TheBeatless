...
namespace TGS {
	...
	public partial class TerrainGridSystem : MonoBehaviour {
		...
		public GameObject TerritoryToggleRegionSurface (int territoryIndex, bool visible, Color color) {
			return TerritoryToggleRegionSurface (territoryIndex, visible, color, null, Vector2.one, Vector2.zero, 0, false);
		}
		...
		public GameObject TerritoryToggleRegionSurface (int territoryIndex, bool visible, Color color,  bool refreshGeometry, Texture2D texture) {
			return TerritoryToggleRegionSurface(territoryIndex, visible, color, texture, Vector2.one, Vector2.zero, 0, false);
		}
